...
PROTO_FILES = "$(PROTO_DIR)/sro/gamedata/gamedata.proto"
...
test-watch:
	ginkgo watch --randomize-all -p --cover -covermode atomic -coverprofile=$(COVERAGE_FILE) -output-dir=$(ROOT_DIR) --output-interceptor-mode=none $(ROOT_DIR)/...
